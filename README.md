kplan — Robust Planning in Non-Deterministic Domains
...
Blue edges represent policy actions, red edges represent adverse outcomes.
...
The original idea of the k-plan algorithm was developed in an academic context
under the guidance of Professor Benedetto Intrigila (2012).
